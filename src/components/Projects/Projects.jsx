  ...
  return (
    ...
    >
      <div className="w-fit flex justify-center flex-col items-center font-semibold relative">
        <h2 className="text-3xl m-8 font-bold">Listen to me</h2>
        <motion.div
          initial="hidden"
          animate="visible"
      ...
      <Spotify className="w-[500px] max-w-[85vw]"  link="https://open.spotify.com/artist/1pgvtOneo1dhcIp9An2xnC?si=XjoA_Av7Q6OPE-dypMgIeQ" />
